...
import 'package:apotik_app/views/auth/register.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void loginToSystem() async {
    ...
    final response = await http.post(
        Uri.parse("http://172.20.10.5/test_apii/login.php"),
        body: jsonEncode({"email": email.text, "password": password.text}));
    int statCode = response.statusCode;
    if (statCode == 200) {
      Navigator.pop(context);
      bool _isLogin = true;
      if (_rememberMe) saveDataLogin(_isLogin, email.text);
      String resStatus = email.text;
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          fillColor: email.text.isNotEmpty
              ? Colors.transparent
    ...
    return SizedBox(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          fillColor: password.text.isNotEmpty
              ? Colors.transparent
              : const Color.fromRGBO(248, 247, 251, 1),
          filled: true,
          enabledBorder: OutlineInputBorder(
    ...
    return Row(
      ...
      children: <Widget>[
        const Expanded(
            flex: 2,
            child: Divider(
              color: Color.fromARGB(255, 150, 154, 168),
            )),
        Expanded(
          flex: 3,
          child: Text(
            ...
            style: GoogleFonts.inter(
              fontSize: 12.0,
              color: const Color.fromARGB(255, 150, 154, 168),
              fontWeight: FontWeight.w500,
              height: 1.67,
            ),
          ),
